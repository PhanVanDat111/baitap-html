...
// var myName = "Alice"; // Hợp lệ: sử dụng chữ cái và viết theo camelCase
// var _totalAmount = 100; // Hợp lệ: bắt đầu bằng dấu gạch dưới
// var $price = 50.5; // Hợp lệ: sử dụng ký tự $
