const products = [
    {
      ...
      price: 35990000,
      image: 'https://hunganh.vn/cdn/upload/images/thay-man-hinh-msi-gf63-min.jpg',
    ...
    },
    {
      ...
      price: 28990000,
      image: 'https://th.bing.com/th/id/OIP.n5ZEEe4C910Ed2cLhNKjPAHaEK?rs=1&pid=ImgDetMain',
    ...
    },
    {
      ...
      price: 3990000,
      image: 'https://th.bing.com/th/id/OIP.kNp66Lw41hQJBWsrxddSZQHaHa?rs=1&pid=ImgDetMain',
      description: 'Loa Bluetooth chống nước với âm bass mạnh mẽ và pin 20 giờ.'
    }
  ];
  
// Lấy phần tử DOM để hiển thị danh sách sản phẩm
            ...
            <div class="col-md-4 product-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Price:</strong> ${product.price.toLocaleString('vi-VN')} VND</p>
