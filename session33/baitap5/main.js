...
const products = [
    {
      ...
      price: 35990000,
      image: 'https://th.bing.com/th/id/R.d66a48254aca2d1e37b8887993a100c2?rik=1leg6QLdFs2iTA&pid=ImgRaw&r=0',
    ...
    },
    {
      ...
      price: 28990000,
      image: 'https://th.bing.com/th/id/OIP.n5Zee4C910eD2cLhNKjPAHaEK?rs=1&pid=ImgDetMain',
    ...
    },
    {
      ...
      price: 3990000,
      image: 'https://th.bing.com/th/id/OIP.kNp66Lw41h0JBWsxrddSZQHaHa?rs=1&pid=ImgDetMain',
  ...
  function displayProducts(productList) {
    ...
    if (productList.length === 0) {
      container.innerHTML = '<p class="text-muted">Không tìm thấy sản phẩm nào.</p>';
      return;
    }
    ...
    productList.forEach(product => {
      ...
      col.innerHTML = `
        <div class="card h-100 shadow-sm">
          <img src="${product.image}" class="card-img-top" style="height: 180px; object-fit: cover;" alt="${product.name}">
          <div class="card-body">
  ...
  // Gắn sự kiện khi nhấn nút search
  document.getElementById('searchBtn').addEventListener('click', searchProducts);
  
  // Gắn sự kiện khi người dùng đang gõ
  document.getElementById('searchInput').addEventListener('input', searchProducts);
  
  // Hiển thị toàn bộ sản phẩm khi load trang
  window.onload = () => {
